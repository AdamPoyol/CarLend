...
CREATE TABLE facture(
        ...
        marque                Varchar (50) NOT NULL ,
        modele                Varchar (50) NOT NULL ,
        id_annonce            int (11) Auto_increment  NOT NULL ,
        date_mise_en_location Date NOT NULL ,
...
CREATE TABLE historique(
        id_changement  int (11) Auto_increment  NOT NULL ,
        id_utilisateur int (11) Auto_increment  NOT NULL ,
        id_annonce     int (11) Auto_increment  NOT NULL ,
...
CREATE TABLE cree_des_infos_de_connexion(
        ...
        id_facture Int NOT NULL ,
        PRIMARY KEY (id_voiture ,id_facture )
)ENGINE=InnoDB;
...
ALTER TABLE vehicule ADD CONSTRAINT FK_vehicule_numero_client FOREIGN KEY (numero_client) REFERENCES Locataire(numero_client);
ALTER TABLE historique ADD CONSTRAINT FK_historique_id_facture FOREIGN KEY (id_facture) REFERENCES facture(id_facture);
ALTER TABLE cree_des_infos_de_connexion ADD CONSTRAINT FK_cree_des_infos_de_connexion_id_voiture FOREIGN KEY (id_voiture) REFERENCES vehicule(id_voiture);
